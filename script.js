...
function setupGapFill(feedback) {
    ...
    const checkAnswers = () => {
        ...
        if (allCorrect) {
            ...
            screenStates[currentScreen].completed = true; // Mark as completed for state
        } else {
            feedback.textContent = "Not quite, try again.";
            feedback.className = "feedback incorrect";
            screenStates[currentScreen].completed = false; // Mark as not completed
        }
    };
