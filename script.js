...
const screenData = [
    ...
    },
    {
        ...
        content: `
            ...
            <iframe style="width:100%; height:350px; border-radius: 8px;" 
                    src="https://www.youtube.com/embed/nL2cYLQ-3Ew" 
                    title="Haunted House Sounds" 
                    frameborder="0" 
                    allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
                    allowfullscreen>
            </iframe>
            <p style="text-align:center; margin-top:10px;"><em>Listen for creaking, rattling, and slamming sounds.</em></p>
        `,
        type: "info"
    },
    {
    ...
    // --- Section 2: Thermodynamics ---
    {
        ...
        content: `
            <p>Investigators claim spirits 'drain heat energy' from the air, causing cold spots. But this breaks the laws of <strong>Thermodynamics</strong>.</p>
            <p>Watch this video for a simple guide to the First Law of Thermodynamics.</p>
            <iframe style="width:100%; height:350px; border-radius: 8px;"
                    src="https://www.youtube.com/embed/gqOo-mExVfE"
    ...
    },
    {
        ...
        content: `
            <p>As you saw, this is a simple but unbreakable rule: <strong>Energy cannot be created or destroyed, only moved or changed from one form to another.</strong></p>
            <div class="analogy">
    ...
    // --- Section 3: Material Science ---
    {
        ...
        content: `
            <p>The house groans and creaks at night. Is it a restless spirit, or <strong>Material Science</strong>? This is often caused by <strong>Thermal Expansion</strong>.</p>
            <p>Watch this simple demo of thermal expansion in action.</p>
             <iframe style="width:100%; height:350px; border-radius: 8px;"
                    src="https://www.youtube.com/embed/hX-B9-pZvA4"
    ...
    },
    {
        ...
        content: `
            <p>As you saw, most materials get slightly <strong>bigger</strong> when they get hot and <strong>smaller</strong> when they get cold. This is 'Thermal Expansion and Contraction'.</p>
            <div class="example">
    ...
    // --- Section 4: Bernoulli's Principle ---
    {
        ...
        content: `
            ...
            <p>Watch these simple demos to see this principle in action.</p>
             <iframe style="width:100%; height:350px; border-radius: 8px;"
                    src="https://www.youtube.com/embed/B-y-i2-226E"
                    title="Bernoulli's Principle Demos" 
                    frameborder="0" 
                    allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
                    allowfullscreen>
            </iframe>
    ...
    },
    {
        ...
        content: `
            <p>As you saw, Bernoulli's Principle states that a stream of <strong>fast-moving air has lower pressure</strong> than the <strong>slow-moving air</strong> around it.</p>
            <div class="analogy">
...
function updateNavButtons() {
    ...
    if (screen.type === 'intro' || screen.type === 'score') {
        ...
        // On all other screens, show the 'Next' button and make sure it is ENABLED
        nextBtn.style.visibility = 'visible';
        nextBtn.disabled = false; // <-- This is the corrected line
    }
}
...
function setupGapFill(feedback) {
    ...
    inputs.forEach(input => {
        ...
        if (screenStates[currentScreen].answer && screenStates[currentScreen].answer[input.id]) {
            input.value = screenStates[currentScreen].answer[input.id];
        }
        
        // Add listener
        input.addEventListener('input', () => {
             // Store the answer
            if (!screenStates[currentScreen].answer) screenStates[currentScreen].answer = {};
            screenStates[currentScreen].answer[input.id] = input.value;
            // Check answers
            checkAnswers(input);
        });
    });
    ...
    selects.forEach(select => {
        select.addEventListener('change', () => {
             if (screenStates[currentScreen].completed) {
                ...
                screenStates[currentScreen].completed = false;
                // Reset score if they were right before
                if (screenStates[currentScreen].score > 0) {
                     screenStates[currentScreen].score = 0;
                     updateTotalScore();
                }
             }
...
function renderScore() {
    // Recalculate score one last time to be safe
    updateTotalScore();
...
/**
 * Recalculates the total score from the screenStates array
 */
